...
that exhibit the union of visual and textual changes (see Figure \ref{fig:chap7_task}). This
...
Section~\ref{sec:chap7_rw} reviews related work on composed
retrieval, bi-temporal change understanding, and
vision-language models for Earth Observation.
Section~\ref{sec:chap7_dataset} describes the CTCR-RS task
formalization and dataset construction pipeline.
Section~\ref{sec:chap7_method} presents the UniCTCR and
StageCTCR architectures. Section~\ref{sec:chap7_experiments}
reports experimental results including ablation studies,
complexity analysis, and qualitative examples.
Section~\ref{sec:chap7_impact} discusses broader impact and
ethical considerations. Section~\ref{sec:chap7_conclusion}
...
\label{sec:chap7_dataset}
% ============================================================
 
\subsection{Task Formalization}
\label{sec:chap7_task}
...
Section~\ref{sec:chap7_ontology}.
...
discussed in Section~\ref{sec:chap7_audit}.
...
Figure~\ref{fig:chap7_stats} (top left).
 
\textbf{Change co-occurrence.} Building Added and Bareland
Removed co-occur strongly (Figure~\ref{fig:chap7_stats},
...
shown in Section~\ref{sec:chap7_experiments}.
...
Section~\ref{sec:chap7_unictr_training}, which encourages
...
Section~\ref{sec:chap7_setup} accounts for all valid
positives.
 
\subsection{Compositional Triplet Generation}
\label{sec:chap7_triplets}
...
in Section~\ref{sec:chap7_conclusion}.
See Figure~\ref{fig:chap7_pipeline} for a visual overview of
the full dataset curation pipeline.

\subsection{Human Audit and Quality Validation}
\label{sec:chap7_audit}
...
successes (Figure~\ref{fig:chap7_audit_success}), LLM
extraction misses (Figure~\ref{fig:chap7_audit_miss}),
and annotator errors and ambiguities
(Figure~\ref{fig:chap7_audit_error}).
...
Figure~\ref{fig:chap7_arch} provides an overview of both.
...
\begin{figure}[ht]
    ...
    \label{fig:chap7_arch}
\end{figure}
 
\subsection{UniCTCR}
\label{sec:chap7_unictr}
...
\label{sec:chap7_unictr_features}
...
%Our ablation study (Table~\ref{tab:chap7_fusion}) shows
...
\label{sec:chap7_unictr_composition}
...
\label{sec:chap7_unictr_training}
...
\label{sec:chap7_stagectcr}
 
Motivated by the oracle analysis of UniCTCR (see Table \ref{tab:chap7_fusion}), which reveals
...
\label{sec:chap7_experiments}
% ============================================================
 
\subsection{Experimental Setup}
\label{sec:chap7_setup}
...
Composition Heads}
\label{sec:chap7_unictr_results}
...
\label{sec:chap7_stagectcr_results}
\begin{table}[htb]
\centering
\footnotesize
...
Table~\ref{tab:chap7_stagectcr}) yields R@1 = 0.41, an 8\% gap that isolates Stage~1 errors. This
...
\begin{figure}[ht]
    ...
    \label{fig:chap7_qual_failure}
\end{figure}
 
Figure~\ref{fig:chap7_qual_success} illustrates a success
case in which StageCTCR outperforms UniCTCR due to its
explicit compositional reasoning. Figure~\ref{fig:chap7_qual_failure}
...
\label{sec:chap7_impact}
% ============================================================
 
\subsection{Operational Value}
\label{sec:chap7_impact_value}
